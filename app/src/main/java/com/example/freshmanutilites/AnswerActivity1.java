...
public class AnswerActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et = findViewById(R.id.answer_er_edittext);
        bt = findViewById(R.id.reply_submit);
    ...
    AllQues = database.getReference("All Questions Varsity").child(postkey).child("Answer");
