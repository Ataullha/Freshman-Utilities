...
public class YourQues4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_your_ques4);

        recyclerView = findViewById(R.id.deep_fav_ques4);
        ...
        FirebaseRecyclerOptions<QuestionsMember4> options4 = new FirebaseRecyclerOptions.Builder<QuestionsMember4>().setQuery(UserQues,QuestionsMember4.class).build();
        FirebaseRecyclerAdapter<QuestionsMember4,ViewHolder_Question> firebaseRecyclerAdapter4 = new FirebaseRecyclerAdapter<QuestionsMember4, ViewHolder_Question>(options4) {
            ...
            protected void onBindViewHolder(@NonNull ViewHolder_Question holder, int position, @NonNull QuestionsMember4 model) {
                ...
                holder.setitemyourques4(getApplication(),model.getName(),model.getUrl(),model.getUserid(),model.getKey(),model.getQues(),model.getTime());
//for reply
                //for reply
                ...
                holder.reply.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(YourQues4.this,ReplyActivity4.class);
            ...
            public ViewHolder_Question onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.your_ques_items4, parent, false);
