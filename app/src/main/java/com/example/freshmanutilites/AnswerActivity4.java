...
public class AnswerActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et = findViewById(R.id.answer_er_edittext4);
        bt = findViewById(R.id.reply_submit4);
        ...
        AllQues= database.getReference("All Questions Others").child(postkey).child("Answer");
