        ...
        switch (requestCode) {
            case LOCATION_REQUEST_CODE: {
                if (grantResults.length > 0
                    ...
                    Toast.makeText(getApplicationContext(), "Few Permissions are Denied!", Toast.LENGTH_SHORT).show();
    ...
    private void getMyLocation() {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                ...
                end = new LatLng(24.917223,91.831913);
                //start route finding
    ...
    public void Findroutes(LatLng Start, LatLng End)
    {
        ...
        else
        {
            ...
            Routing routing = new Routing.Builder()
                    ...
                    .waypoints(Start, End)
                    .key("AIzaSyAREfZJ0b_7sriRWtL5B-52Y0mP7soKJW0")  //also define your api key here.
                    .build();
            routing.execute();
        }
    }
