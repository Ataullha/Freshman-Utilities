...
public class AnswerActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        member = new AnswerMember3() ;
        et = findViewById(R.id.answer_er_edittext3);
        bt = findViewById(R.id.reply_submit3);
        ...
        AllQues= database.getReference("All Questions Academic").child(postkey).child("Answer");
